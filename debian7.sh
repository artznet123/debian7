...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/artznet123/debian7/master/sources.list.debian7"
...
# install screenfetch
cd
wget 'https://raw.githubusercontent.com/artznet123/debian7/master/screenfetch-dev'
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/artznet123/debian7/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>www.fornesia.com</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/artznet123/debian7/master/vps.conf"
...
useradd -M -s /bin/false artznet
echo "artznet:$PASS" | chpasswd
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/artznet123/debian7/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/artznet123/debian7/master/mrtg-mem.sh"
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/artznet123/debian7/master/squid3.conf"
...
# download script
cd
wget -O speedtest_cli.py "https://raw.githubusercontent.com/artznet123/debian7/master/speedtest_cli.py"
wget -O bench-network.sh "https://raw.githubusercontent.com/artznet123/debian7/master/bench-network.sh"
wget -O ps_mem.py "https://raw.githubusercontent.com/artznet123/debian7/master/ps_mem.py"
wget -O dropmon "https://raw.githubusercontent.com/artznet123/debian7/master/dropmon.sh"
wget -O user-login.sh "https://raw.githubusercontent.com/artznet123/debian7/master/user-login.sh"
wget -O user-expired.sh "https://raw.githubusercontent.com/artznet123/debian7/master/user-expired.sh"
#wget -O userlimit.sh "https://raw.githubusercontent.com/suryadewa/fornesiavps/fns/limit.sh"
wget -O user-list.sh "https://raw.githubusercontent.com/artznet123/debian7/master/user-list.sh"
wget -O /etc/issue.net "https://raw.githubusercontent.com/artznet123/debian7/master/banner"
...
echo ""  | tee -a log-install.txt
echo "Auto Script Installer Vps - Artznet"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "Log Instalasi --> /root/log-install.txt"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "VPS AUTO REBOOT TIAP 1 Hari, SILAHKAN REBOOT VPS ANDA !"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "==========================================="  | tee -a log-install.txt
cd
